...
def run_simulation(seed_1, seed_2, onset, duration,environment): 
    ...
    cbgt.saveResults(results, data_dir+'network_data_onset_'+str(onset)+'_duration_'+str(duration),['popfreqs','popdata', 'datatables'])
